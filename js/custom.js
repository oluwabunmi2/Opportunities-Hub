...
document.getElementById('contact.html').addEventListener('submit', function (event) {
    event.preventDefault();
    // Add your form submission logic here (e.g., sending data to the server)
    // Assuming successful submission, show confirmation message
    showConfirmationMessage('Your message has been sent successfully!');
  });
